...
function themeConfig($form) {
	...
	//设置侧边栏样式
	$sidebarstyle = new Typecho_Widget_Helper_Form_Element_Radio('sidebarstyle', array('展开','折叠'), array('post-template tag-getting-started  pace-done drawer-open drawer-transition','post-template tag-getting-started'), _t('侧边栏样式'), _t('设置侧边栏的默认样式'));
