...
<nav tabindex="-1" class="drawer">
  <div class="drawer-container"> 
    ...
    <ul role="navigation" class="drawer-list">
      ...
      <li class="drawer-list-item"> <a href="https://git.oschina.net/79257 target="_blank"> <i class="fa fa-git"></i>Git@OSC </a> </li>
      <li class="drawer-list-item"> <a href="https://github.com/79257" target="_blank"> <i class="fa fa-github"></i>Github </a> </li>
      <li class="drawer-list-item"> <a href="http://wpa.qq.com/msgrd?v=3&uin=604163270&site=qq&menu=ye" target="_blank"> <i class="fa fa-qq"></i>QQ </a> </li>
    </ul>
  </div>
</nav>
